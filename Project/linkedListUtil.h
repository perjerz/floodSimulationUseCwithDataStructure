 ...
 *	Recent Modified By Mr.Siwat Karwlung (JaMe) ID 56070503434 CPE
 *	Add 2 variable to use in flood simulation
 *  array riverName use for the hash table which store likely to dictionary (chain hash table)
 *  headRiver is used for store the head river of the system
 */
...
LIST_HANDLE headRiver;/*use for store head of the river*/
LIST_HANDLE riverName[26]; /*use for store all of the river name which  is seperated by the first letter */
LIST_HANDLE newList();
